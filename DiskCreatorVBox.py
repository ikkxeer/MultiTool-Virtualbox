...
class VirtualBoxDiskCreator:
    ...
    def create_widgets(self):
        ...
        self.virtualbox_button = tk.Button(self.root, text="Seleccionar", command=self.select_virtualbox_directory)
        self.virtualbox_button.pack()
        ...
        self.machine_combobox = ttk.Combobox(self.root, values=machines_list, textvariable=self.selected_machine)
        self.machine_combobox.pack(pady=(20, 0))
        ...
        self.num_disks_entry.pack(pady=(0, 20))
        ...
        self.disk_size_entry.pack(pady=(20, 0))
        ...
        self.disk_name_entry.pack(pady=(20, 0))

        # Button to start the disk creation process
        self.create_button = tk.Button(self.root, text="Crear Discos", command=self.create_disks)
